{ flake-parts-lib, lib, ... }:
{
  imports = [
    {
      perSystem = lib.modules.mkRenamedOptionModule [ "nix4dev" "managedFiles" ] [ "managedFiles" ];
    }
  ];
        ...
        let
            ...
            pkgs.writeShellScript "list-managed-files" ''
              ...
              cat <<EOF
              {
                "_comment": [
                  ...
                  "This file was generated by managedFiles.",
          ...
          updateFilesScript =
            ...
            pkgs.writeShellScript "update-managed-files" ''
              ...
              outDir="$1"
              tmpFileListPath="$(mktemp --tmpdir -- managed-files-file-list-new-XXXXXX.json)"
